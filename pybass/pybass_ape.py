...
if platform.system().lower() == 'windows':
    ...
    bass_ape_module = ctypes.CDLL('libbass_ape.dylib', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
else:
    bass_ape_module = ctypes.CDLL('libbass_ape.so', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
...
BASS_APE_StreamCreateFile = func_type(HSTREAM, ctypes.c_byte, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
...
BASS_APE_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                          ctypes.c_void_p)(('BASS_APE_StreamCreateFileUser', bass_ape_module))
