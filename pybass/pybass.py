...
BASS_Init = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p, ctypes.c_void_p)(
...
BASS_Set3DFactors = func_type(ctypes.c_bool, ctypes.c_float, ctypes.c_float, ctypes.c_float)(
    ('BASS_Set3DFactors', bass_module))
# BOOL BASSDEF(BASS_Get3DFactors)(float *distf, float *rollf, float *doppf);
BASS_Get3DFactors = func_type(ctypes.c_bool, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float),
                              ctypes.POINTER(ctypes.c_float))(('BASS_Get3DFactors', bass_module))
...
BASS_Set3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR),
...
BASS_Get3DPosition = func_type(ctypes.c_bool, ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR),
                               ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(
...
BASS_MusicLoad = func_type(HMUSIC, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong, ctypes.c_ulong,
                           ctypes.c_ulong)(('BASS_MusicLoad', bass_module))
...
BASS_SampleLoad = func_type(HSAMPLE, ctypes.c_bool, ctypes.c_void_p, QWORD, ctypes.c_ulong, ctypes.c_ulong,
                            ctypes.c_ulong)(('BASS_SampleLoad', bass_module))
# HSAMPLE BASSDEF(BASS_SampleCreate)(DWORD length, DWORD freq, DWORD chans, DWORD max, DWORD flags);
BASS_SampleCreate = func_type(HSAMPLE, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_SampleGetChannels = func_type(ctypes.c_ulong, HSAMPLE, ctypes.POINTER(HCHANNEL))(
...
BASS_StreamCreate = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, STREAMPROC, ctypes.c_void_p)(
...
BASS_StreamCreateFile = func_type(HSTREAM, ctypes.c_bool, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
...
BASS_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong, DOWNLOADPROC,
                                 ctypes.c_void_p)(('BASS_StreamCreateURL', bass_module))
# HSTREAM BASSDEF(BASS_StreamCreateFileUser)(DWORD system, DWORD flags, const BASS_FILEPROCS *proc, void *user);
BASS_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                      ctypes.c_void_p)(('BASS_StreamCreateFileUser', bass_module))
...
BASS_StreamPutData = func_type(ctypes.c_ulong, HSTREAM, ctypes.c_void_p, ctypes.c_ulong)(
    ('BASS_StreamPutData', bass_module))
# DWORD BASSDEF(BASS_StreamPutFileData)(HSTREAM handle, const void *buffer, DWORD length);
BASS_StreamPutFileData = func_type(ctypes.c_ulong, HSTREAM, ctypes.c_void_p, ctypes.c_ulong)(
    ('BASS_StreamPutFileData', bass_module))

# BOOL BASSDEF(BASS_RecordGetDeviceInfo)(DWORD device, BASS_DEVICEINFO *info);
BASS_RecordGetDeviceInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_DEVICEINFO))(
...
BASS_RecordSetInput = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_float)(
...
BASS_RecordStart = func_type(HRECORD, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, RECORDPROC, ctypes.c_void_p)(
    ('BASS_RecordStart', bass_module))

# double BASSDEF(BASS_ChannelBytes2Seconds)(DWORD handle, QWORD pos);
BASS_ChannelBytes2Seconds = func_type(ctypes.c_double, ctypes.c_ulong, QWORD)(
    ('BASS_ChannelBytes2Seconds', bass_module))
# QWORD BASSDEF(BASS_ChannelSeconds2Bytes)(DWORD handle, double pos);
BASS_ChannelSeconds2Bytes = func_type(QWORD, ctypes.c_ulong, ctypes.c_double)(
...
BASS_ChannelGetInfo = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_CHANNELINFO))(
...
BASS_ChannelFlags = func_type(ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_ChannelSetAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_float)(
    ('BASS_ChannelSetAttribute', bass_module))
# BOOL BASSDEF(BASS_ChannelGetAttribute)(DWORD handle, DWORD attrib, float *value);
BASS_ChannelGetAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(ctypes.c_float))(
...
BASS_ChannelSlideAttribute = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_float, ctypes.c_ulong)(
...
BASS_ChannelSet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_int, ctypes.c_float, ctypes.c_float,
...
BASS_ChannelGet3DAttributes = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(ctypes.c_ulong),
                                        ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float),
                                        ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_ulong),
                                        ctypes.POINTER(ctypes.c_float))(('BASS_ChannelGet3DAttributes', bass_module))
...
BASS_ChannelSet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR),
                                      ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(
...
BASS_ChannelGet3DPosition = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.POINTER(BASS_3DVECTOR),
                                      ctypes.POINTER(BASS_3DVECTOR), ctypes.POINTER(BASS_3DVECTOR))(
...
BASS_ChannelSetPosition = func_type(ctypes.c_bool, ctypes.c_ulong, QWORD, ctypes.c_ulong)(
...
BASS_ChannelGetData = func_type(ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p, ctypes.c_ulong)(
...
BASS_ChannelSetSync = func_type(HSYNC, ctypes.c_ulong, ctypes.c_ulong, QWORD, SYNCPROC, ctypes.c_void_p)(
...
BASS_ChannelSetDSP = func_type(HDSP, ctypes.c_ulong, DSPPROC, ctypes.c_void_p, ctypes.c_int)(
...
BASS_ChannelRemoveLink = func_type(ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong)(
...
if platform.system().lower() == 'windows':
    ...
    BASS_Init = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p)(
        ('BASS_Init', bass_module))
    ...
    BASS_SetEAXParameters = func_type(ctypes.c_bool, ctypes.c_int, ctypes.c_float, ctypes.c_float, ctypes.c_float)(
        ('BASS_SetEAXParameters', bass_module))
    # BOOL BASSDEF(BASS_GetEAXParameters)(DWORD *env, float *vol, float *decay, float *damp);
    BASS_GetEAXParameters = func_type(ctypes.c_bool, ctypes.POINTER(ctypes.c_ulong), ctypes.POINTER(ctypes.c_float),
                                      ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float))(
