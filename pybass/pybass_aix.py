...
if platform.system().lower() == 'windows':
    bass_ac3_module = ctypes.WinDLL('bass_aix')
    func_type = ctypes.WINFUNCTYPE
else:
    raise RuntimeError("AIX is not supported on non-Windows platforms")
...
BASS_AIX_StreamCreateFile = func_type(HSTREAM, ctypes.c_byte, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
...
BASS_AIX_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong, DOWNLOADPROC,
                                     ctypes.c_void_p)(('BASS_AIX_StreamCreateURL', bass_ac3_module))
# HSTREAM BASSAIXDEF(BASS_AIX_StreamCreateFileUser)(DWORD system, DWORD flags, BASS_FILEPROCS *procs, void *user);
BASS_AIX_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                          ctypes.c_void_p)(('BASS_AIX_StreamCreateFileUser', bass_ac3_module))
