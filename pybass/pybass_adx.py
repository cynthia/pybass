...
if platform.system().lower() == 'windows':
    ...
    raise RuntimeError("ADX is not supported on non-Windows platforms")
...
BASS_ADX_StreamCreateFile = func_type(HSTREAM, ctypes.c_byte, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
...
BASS_ADX_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong, DOWNLOADPROC,
                                     ctypes.c_void_p)(('BASS_ADX_StreamCreateURL', bass_adx_module))
# HSTREAM BASSADXDEF(BASS_ADX_StreamCreateFileUser)(DWORD system, DWORD flags, BASS_FILEPROCS *procs, void *user);
BASS_ADX_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                          ctypes.c_void_p)(('BASS_ADX_StreamCreateFileUser', bass_adx_module))
