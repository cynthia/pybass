...
if platform.system().lower() == 'windows':
    ...
    bass_ac3_module = ctypes.CDLL('libbass_ac3.dylib', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
else:
    bass_ac3_module = ctypes.CDLL('libbass_ac3.so', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
...
BASS_AC3_StreamCreateFile = func_type(HSTREAM, ctypes.c_byte, ctypes.c_void_p, QWORD, QWORD, ctypes.c_ulong)(
...
BASS_AC3_StreamCreateURL = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_ulong, ctypes.c_ulong, DOWNLOADPROC,
                                     ctypes.c_void_p)(('BASS_AC3_StreamCreateURL', bass_ac3_module))
# HSTREAM BASSAC3DEF(BASS_AC3_StreamCreateFileUser)(DWORD system, DWORD flags, const BASS_FILEPROCS *procs, void *user);
BASS_AC3_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                          ctypes.c_void_p)(('BASS_AC3_StreamCreateFileUser', bass_ac3_module))
