...
BASS_ASIO_GetDeviceInfo = func_type(ctypes.c_byte, ctypes.c_ulong, ctypes.POINTER(BASS_ASIO_DEVICEINFO))(
...
BASS_ASIO_SetNotify = func_type(ctypes.c_byte, ASIONOTIFYPROC, ctypes.c_void_p)(
...
BASS_ASIO_Monitor = func_type(ctypes.c_byte, ctypes.c_int, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_ulong,
                              ctypes.c_ulong)(('BASS_ASIO_Monitor', bassasio_module))

# BOOL BASSASIODEF(BASS_ASIO_ChannelGetInfo)(BOOL input, DWORD channel, BASS_ASIO_CHANNELINFO *info);
BASS_ASIO_ChannelGetInfo = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong,
                                     ctypes.POINTER(BASS_ASIO_CHANNELINFO))(
    ('BASS_ASIO_ChannelGetInfo', bassasio_module))
# BOOL BASSASIODEF(BASS_ASIO_ChannelReset)(BOOL input, int channel, DWORD flags);
BASS_ASIO_ChannelReset = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_int, ctypes.c_ulong)(
...
BASS_ASIO_ChannelEnable = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ASIOPROC, ctypes.c_void_p)(
...
BASS_ASIO_ChannelEnableMirror = func_type(ctypes.c_byte, ctypes.c_ulong, ctypes.c_byte, ctypes.c_ulong)(
...
BASS_ASIO_ChannelJoin = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong, ctypes.c_int)(
    ('BASS_ASIO_ChannelJoin', bassasio_module))
# BOOL BASSASIODEF(BASS_ASIO_ChannelPause)(BOOL input, DWORD channel);
BASS_ASIO_ChannelPause = func_type(ctypes.c_byte, ctypes.c_byte, ctypes.c_ulong)(
    ('BASS_ASIO_ChannelPause', bassasio_module))
# DWORD BASSASIODEF(BASS_ASIO_ChannelIsActive)(BOOL input, DWORD channel);
BASS_ASIO_ChannelIsActive = func_type(ctypes.c_ulong, ctypes.c_byte, ctypes.c_ulong)(
