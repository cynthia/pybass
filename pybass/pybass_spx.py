...
if platform.system().lower() == 'windows':
    ...
    bass_spx_module = ctypes.CDLL('libbass_spx.dylib', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
else:
    bass_spx_module = ctypes.CDLL('libbass_spx.so', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
...
BASS_SPX_StreamCreateFileUser = func_type(HSTREAM, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(BASS_FILEPROCS),
                                          ctypes.c_void_p)(('BASS_SPX_StreamCreateFileUser', bass_spx_module))
