...
if platform.system().lower() == 'windows':
    ...
    raise RuntimeError("BASS_SFX is not supported on non-Windows platforms")
...
BASS_SFX_WMP_GetPlugin = func_type(HSTREAM, ctypes.c_int, ctypes.POINTER(BASS_SFX_PLUGININFO))(
    ('BASS_SFX_WMP_GetPlugin', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_WMP_GetPluginW)(int index, BASS_SFX_PLUGININFOW* info);
BASS_SFX_WMP_GetPluginW = func_type(HSTREAM, ctypes.c_int, ctypes.POINTER(BASS_SFX_PLUGINFOW))(
...
BASS_SFX_PluginFlags = func_type(HSTREAM, HSFX, ctypes.c_ulong, ctypes.c_ulong)(
...
BASS_SFX_PluginCreate = func_type(HSTREAM, ctypes.c_char_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_int,
                                  ctypes.c_ulong)(('BASS_SFX_PluginCreate', bass_vst_module))
# HSFX		SFXDEF(BASS_SFX_PluginCreateW)(LPCWSTR strPath, HWND hPluginWnd, int nWidth, int nHeight, DWORD flags);
BASS_SFX_PluginCreateW = func_type(HSTREAM, ctypes.c_wchar_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_int,
                                   ctypes.c_ulong)(('BASS_SFX_PluginCreate', bass_vst_module))
...
BASS_SFX_PluginModuleGetNameW = func_type(HSTREAM, HSFX, ctypes.c_int)(
    ('BASS_SFX_PluginModuleGetNameW', bass_vst_module))
# BOOL		SFXDEF(BASS_SFX_PluginModuleSetActive)(HSFX handle, int module);
BASS_SFX_PluginModuleSetActive = func_type(HSTREAM, HSFX, ctypes.c_int)(
...
BASS_SFX_PluginClicked = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int)(
...
BASS_SFX_PluginResizeMove = func_type(HSTREAM, HSFX, ctypes.c_int, ctypes.c_int, ctypes.c_int, ctypes.c_int)(
